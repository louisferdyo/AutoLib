...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.refresh(); // Memastikan session data terefresh
    } catch (error) {
        ...
        <div className="w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-sm py-8 px-6 sm:px-10 rounded-2xl shadow-xl border border-indigo-100">
            <div className="mb-8 text-center">
              <h2 className="text-3xl font-extrabold text-indigo-700 mb-1">Selamat Datang Kembali</h2>
              <p className="text-purple-500">Masuk untuk melanjutkan ke AutoLib</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="appearance-none block w-full pl-10 pr-3 py-2 border border-indigo-200 rounded-lg shadow-sm placeholder-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 bg-white/70 backdrop-blur-sm sm:text-sm"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-indigo-600">
                    Ingat saya
                  </label>
                </div>

                <div className="text-sm">
                  <a href="#" className="font-medium text-purple-600 hover:text-purple-500 transition-all duration-300">
                    Lupa kata sandi?
                  </a>
                </div>
              </div>
            ...
            <div className="transform rotate-6 transition-transform duration-500 hover:rotate-0 hover:scale-110">
              <div className="w-40 h-28 bg-gradient-to-br from-indigo-500 via-purple-500 to-blue-500 rounded-xl shadow-lg relative overflow-hidden group">
                ...
                <div className="absolute inset-x-0 bottom-0 px-3 py-2">
                  ...
                  <div className="text-blue-100 text-xs">ID: 123456789</div>
                </div>
              </div>
            </div>
          </div>
