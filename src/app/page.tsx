...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <nav className="bg-white shadow-sm z-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8">
              <Link 
                href="/books" 
                className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-500 transition duration-300"
              >
                Books
              </Link>
              <Link 
              ...
              <Link 
                href="/register" 
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 transform hover:scale-105 transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Register
              </Link>
            </div>
        ...
        <div className={`${isMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
          <div className="pt-2 pb-3 space-y-1">
            <Link
              href="/books"
              className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-800 transition duration-300"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 md:mt-12">
            <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-1 lg:grid-cols-2 md:gap-x-8 md:gap-y-8">
              {/* Feature 1 */}
              <div className="relative bg-white p-5 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="ml-14 sm:ml-16">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">RFID Membership Registration</h3>
              ...
              <div className="relative bg-white p-5 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="ml-14 sm:ml-16">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Book Borrowing & Return</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
              ...
              <div className="relative bg-white p-5 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="ml-14 sm:ml-16">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Loan Extension</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
              ...
              <div className="relative bg-white p-5 sm:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="ml-14 sm:ml-16">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Book Status Tracking</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
      ...
      <div className="py-12 md:py-16 bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
          ...
          <div className="mt-10 md:mt-12">
            <div className="space-y-8 md:space-y-0 md:grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-sm">
                ...
                <div className="text-center">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Register & Get RFID Card</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-sm">
                ...
                <div className="text-center">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Browse & Reserve Books</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-sm">
                ...
                <div className="text-center">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Scan RFID at Smart Locker</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-sm">
                ...
                <div className="text-center">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">Return or Extend</h3>
                  <p className="mt-2 text-sm sm:text-base text-gray-500">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              ...
              <ul className="mt-6 space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-sm sm:text-base text-gray-500">
                    <span className="font-medium text-gray-900">Secure Authentication:</span> Your RFID card can only be used by you
                  </p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <p className="ml-3 text-sm sm:text-base text-gray-500">
                    <span className="font-medium text-gray-900">Contactless:</span> No need to manually enter information
                  </p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <p className="ml-3 text-sm sm:text-base text-gray-500">
                    <span className="font-medium text-gray-900">Fast Access:</span> Opens lockers in less than 2 seconds
                  </p>
                </li>
              </ul>
            </div>
            <div className="mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
              <div className="w-60 sm:w-72 h-40 sm:h-48 bg-indigo-100 rounded-lg shadow-md flex items-center justify-center p-4 sm:p-6">
                <div className="relative w-36 sm:w-48 h-24 sm:h-32 bg-white rounded-md shadow-sm transform rotate-6 transition-transform duration-300 hover:rotate-0">
      ...
      <div className="bg-indigo-50">
        <div className="max-w-7xl mx-auto py-10 md:py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl">
        ...
        <div className="max-w-7xl mx-auto py-8 md:py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            <div className="px-5 py-2">
              <Link href="/books" className="text-sm sm:text-base text-gray-500 hover:text-indigo-600 transition duration-300">
                Books
              </Link>
            </div>
            <div className="px-5 py-2">
              <Link href="/about" className="text-sm sm:text-base text-gray-500 hover:text-indigo-600 transition duration-300">
                About
              </Link>
            </div>
            <div className="px-5 py-2">
              <Link href="/contact" className="text-sm sm:text-base text-gray-500 hover:text-indigo-600 transition duration-300">
                Contact
              </Link>
            </div>
            <div className="px-5 py-2">
              <Link href="/faq" className="text-sm sm:text-base text-gray-500 hover:text-indigo-600 transition duration-300">
                FAQ
              </Link>
            </div>
          </nav>
          ...
          <p className="mt-6 md:mt-8 text-center text-sm sm:text-base text-gray-400">
